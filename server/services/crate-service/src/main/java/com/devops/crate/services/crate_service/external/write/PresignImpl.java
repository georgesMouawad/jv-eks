...
import com.devops.crate.services.crate_service.core.write.Presign;
...
@Component
public class PresignImpl implements Presign {

    private final S3Presigner presigner;
    private final String bucketName;

    public PresignImpl(@Value("${aws.s3.bucket-name}") String bucketName,
